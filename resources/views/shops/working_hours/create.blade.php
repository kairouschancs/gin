...
@section('title', '理論労働時間算出係数情報 新規登録')
    ...
    <div class="border col-xl">
      <div class="col-sd">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" id="shop_type_symbol" name="shop_type_symbol" value="{{ old('shop_type_symbol')}}"
        ...
        <div class="border col-xl">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="opening_work" name="opening_work" value="{{ old('opening_work')}}"
              placeholder="オープン準備時間数 を入力" />
            </div>
            {{-- 閉店作業時間数 入力 --}}
            <div class="form-group col-md-4">
              <label for="id">閉店作業<span class="badge badge-secondary ml-2">{{ __('必須') }}</span></label>
              <input type="text" class="form-control" id="closing_work" name="closing_work" value="{{ old('closing_work')}}"
        ...
        <div class="border col-xl">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control" id="4S_Pre_closing" name="4S_Pre_closing" value="{{ old('4S_Pre_closing')}}"
              placeholder="4S・プレクロ を入力" />
            </div>
            {{-- 仕込み 入力 --}}
            <div class="form-group col-md-3">
              <label for="id">仕込み<span class="badge badge-secondary ml-2">{{ __('必須') }}</span></label>
              <input type="text" class="form-control" id="Preparation" name="Preparation" value="{{ old('Preparation')}}"
              placeholder="仕込み を入力" />
            </div>
            {{-- 納金 入力 --}}
            <div class="form-group col-md-3">
            ...
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control" id="order_work" name="order_work" value="{{ old('order_work')}}"
              placeholder="発注 を入力" />
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="form-group col-md-2">
          ...
          <input type="text" class="form-control" id="manager_work" name="manager_work" value="{{ old('manager_work') }}"
        ...
        <div class="form-group col-md-2">
          ...
          <input type="text" class="form-control" id="training" name="training" value="{{ old('training') }}"
        ...
        <div class="form-group col-md-2">
          ...
          <input type="text" class="form-control" id="appointment" name="appointment" value="{{ old('appointment') }}"
          placeholder="Mt を入力" />
        </div>
      </div>
          {{-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ --}}
        ...
        <div class="border col-xl">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="Person_hour_sales" name="Person_hour_sales" value="{{ old('Person_hour_sales') }}"
              placeholder="人時売上係数 を入力" />
            </div>
            {{-- 最低営業人員 入力 --}}
            <div class="form-group col-md-4">
              <label for="id">最低営業人員<span class="badge badge-secondary ml-2">{{ __('必須') }}</span></label>
              <input type="text" class="form-control" id="Minimum_sales_staff" name="Minimum_sales_staff" value="{{ old('Minimum_sales_staff') }}"
        ...
        <div class="border col-xl">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="seven_million_over" name="seven_million_over" value="{{ old('seven_million_over') }}"
              placeholder="700万円以上 を入力" />
            </div>
            {{-- 1,000万円以上 入力 --}}
            <div class="form-group col-md-4">
              <label for="id">1,000万円以上<span class="badge badge-secondary ml-2">{{ __('必須') }}</span></label>
              <input type="text" class="form-control" id="ten_million_over" name="ten_million_over" value="{{ old('ten_million_over') }}"
